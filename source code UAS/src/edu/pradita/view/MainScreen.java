...
import edu.pradita.modelview.DeleteButtonListener;
import edu.pradita.modelview.CancelButtonListener;
import edu.pradita.modelview.SideButtonListener;
...
public class MainScreen extends JFrame {
	...
	private void initialize() {
		...
		SideButtonListener sideButtonListener = new SideButtonListener(this);
		...
		this.getContentPane().add(leftPanel, BorderLayout.WEST);
								...
								btnLeft1.addActionListener(sideButtonListener);
						...
						btnLeft2.addActionListener(sideButtonListener);
						...
						btnLeft3.addActionListener(sideButtonListener);
		...
		rightPanel.setLayout(gbl_rightPanel);
				...
				btnRight1.addActionListener(sideButtonListener);
				...
				rightPanel.add(btnRight1, gbc_btnRight1);
						...
						btnRight2.addActionListener(sideButtonListener);
				...
				btnRight3.addActionListener(sideButtonListener);
